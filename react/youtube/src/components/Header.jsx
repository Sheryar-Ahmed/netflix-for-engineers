    ...
    <header class="header">
        <div class="container">
            <div class="header-left">
                ...
                <div class="logo">
                    <img src="./logo.png" alt="yt logo" width="50px" height="50px" class="menu" />
                    <a href="https://www.youtube.com/" target="_top" class="logo">Youtube <sup>PK</sup></a>
                </div>
            </div>
            <div class="header-center">
                <div>
                    <form action="" class="search-form">
                        ...
                        <input id="search" type="text" autocomplete="off" placeholder="Search for yt"
                            class="search-input"
